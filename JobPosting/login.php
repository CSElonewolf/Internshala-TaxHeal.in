...
<div class="jumbotron text-center">
    ...
    <div class="container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" style="border:2px solid black;width:50%;padding:20px">
    ...
    <!-- footer -->
    <div class="text-center" style="margin-top:30vh;margin-bottom:5vh">
